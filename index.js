...
class Student_manager {
    ...
    add_Student(name) {
        ...
        console.log(`Student: ${name} added successfully. Student ID: ${studentVaribale.id}`);
    }
    ...
    while (true) {
        ...
        switch (choice.Choice) {
            ...
            case "Pay Fess":
                ...
                student_manager.pay_Student_Fee(fess_input.student_id, fess_input.Amount);
                break;
            // Case Show Status
            case "Show Status":
